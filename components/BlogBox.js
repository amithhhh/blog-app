  ...
  return (
    <div className='w-[400px] h-[250px] rounded-md border-1 border-gray-600 p-4 gap-4 relative'>
        <div className='flex flex-row items-center justify-items-center'>
            ...
            <Link href={`/edit/${id}/`}><p className='font-mono text-indigo-700 font-thin'>Edit</p></Link>
        </div>
        ...
        <Link href={`/profile/1/`}><p className='absolute bottom-2 right-2 text-gray-700'>Adolf Hitler</p></Link>
    </div>
  )
}
