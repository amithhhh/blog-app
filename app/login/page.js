            ...
            <div className='w-full max-w-md shadow-lg rounded-lg flex flex-col p-2'>
                ...
                <div>
                    <form method='POST' className='flex flex-col gap-2 mb-4 px-4 py-2'>
                        <label htmlFor='username' className='text-sm font-medium text-gray-700 cursor-pointer'>Username</label>
                        <input type='text' id='username' className='border-2 border-gray-400 rounded-md px-4 py-2 focus:outline-none focus:ring-2 focus:ring-purple-500 transition duration-200' />
                        <label htmlFor='password' className='text-sm font-medium text-gray-700b cursor-pointer'>Password</label>
                        <input type='password' id='password' className='border-2 border-gray-400 rounded-md px-4 py-2 focus:outline-none focus:ring-2 focus:ring-purple-500 transition duration-200 mb-2' />
